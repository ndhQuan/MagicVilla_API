...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNo)
        {
            ...
            var response = await _villaNumberService.GetAsync<APIResponse>(villaNo, HttpContext.Session.GetString(StaticDetail.SessionToken));
            if (response != null && response.IsSuccess)
            {
            ...
            response = await _villaService.GetAllAsync<APIResponse>(HttpContext.Session.GetString(StaticDetail.SessionToken));
            if (response != null && response.IsSuccess)
            {
                villaNumberVM.VillaList = JsonConvert.DeserializeObject<List<VillaDTO>>(Convert.ToString(response.Result)).Select(i => new SelectListItem
                {
